    ...
    <div className="p-8">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <div className="flex items-center gap-3 flex-wrap">
              <h1 className="text-2xl font-bold text-[#18181B]">{profile?.full_name ?? '—'}</h1>
              <span className={`px-3 py-1 rounded-full text-xs font-semibold ${isActive ? 'bg-[#FF6A00] text-white' : 'bg-[#FFE8D1] text-[#71717A]'}`}>
                {isActive ? 'Active' : 'Inactive'}
              </span>
            </div>
            <p className="text-sm text-[#71717A] mt-0.5">{profile?.phone ?? 'No phone'}</p>
          </div>
        </div>
      ...
      <div className="max-w-2xl space-y-5">
        ...
        <div className="bg-white rounded-2xl border border-[#E4E4E7] p-7 shadow-[0_0_15px_rgba(144,77,0,0.06)]">
          <h2 className="text-base font-bold text-[#18181B] mb-1">Tenant Information</h2>
          <p className="text-sm text-[#71717A] mb-6">Current details for this occupant.</p>
        ...
        {/* Bill History */}
        <div className="bg-white rounded-2xl border border-[#E4E4E7] p-7 shadow-[0_0_15px_rgba(144,77,0,0.06)]">
          <h2 className="text-base font-bold text-[#18181B] mb-1">Bill History</h2>
          ...
          {bills.length === 0 ? (
            <div className="rounded-xl border border-dashed border-[#E4E4E7] p-8 text-center">
              <p className="text-sm text-[#71717A]">No bills generated yet for this tenant.</p>
            </div>
          ) : (
