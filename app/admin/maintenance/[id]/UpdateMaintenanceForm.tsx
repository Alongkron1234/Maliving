...
const inputClass =
  ...
  'outline-none focus:border-[#FF6A00] focus:ring-2 focus:ring-[#FF6A00]/20 transition-all capitalize'
...
export default function UpdateMaintenanceForm({
  ...
  return (
    <div className="bg-white rounded-2xl border border-[#E4E4E7] p-7 shadow-[0_0_15px_rgba(144,77,0,0.06)]">
      <h2 className="text-base font-bold text-[#18181B] mb-1">Update Status</h2>
      <p className="text-sm text-[#71717A] mb-6">Track progress on this request.</p>

      <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-5 gap-y-5 mb-6">
        <div>
          <label className="block text-sm font-semibold text-[#18181B] mb-2">Status</label>
        ...
        <div>
          <label className="block text-sm font-semibold text-[#18181B] mb-2">Priority</label>
      ...
      <button
        ...
        className={`px-6 py-2.5 text-sm font-semibold rounded-lg transition-colors disabled:opacity-60 disabled:cursor-not-allowed ${
          saved ? 'bg-[#f0fdf4] border border-[#86efac] text-[#16a34a]' : 'bg-[#FF6A00] hover:bg-[#C2410C] text-white'
        }`}
      >
