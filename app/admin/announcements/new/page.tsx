  ...
  return (
    <div className="p-8">
      <div className="mb-7">
        ...
        <h1 className="text-2xl font-bold text-[#18181B]">New Announcement</h1>
        <p className="text-sm text-[#71717A] mt-1">Post an update for all tenants to see.</p>
      </div>
      ...
      <div className="max-w-2xl">
        <form onSubmit={handleSubmit}>
          <div className="bg-white rounded-2xl border border-[#E4E4E7] p-7 shadow-[0_0_15px_rgba(144,77,0,0.06)]">
            ...
            <p className="text-sm text-[#71717A] mb-7">Write the title and content of your announcement.</p>
